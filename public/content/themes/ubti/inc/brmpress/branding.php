...
function brm_admin_footer_text () {
  echo 'Website developed by <a href="https://www.brmwebdev.com">BRM Web Dev, LLC</a>. For support, email <a href="mailto:info@brmwebdev.com">info@brmwebdev.com</a>.';
}
...
function brm_support_display() {
    echo <<<'EOT'
<p><strong>Congratulations</strong> on your new website built by <a href="https://www.brmwebdev.com">BRM Web Dev</a>. Your new website comes with <strong>6 months</strong> of technical support, ending on <strong>August 10<sup>th</sup>, 2017</strong>.</p>
<h3 style="font-weight:bold;">Technical Support:</h3>
<ul style="margin-top:0;">
    <li><strong>Email:</strong> <a href="mailto:info@brmwebdev.com">info@brmwebdev.com</a></li>
    <li><strong>Phone:</strong> 817-900-0337</li>
</ul>
<hr>
<h3 style="font-weight:bold;margin-top:20px;">Content Updates:</h3>
<p>If you need updates to your content or website design, please contact your BRM Web Dev Project Manager:</p>
<ul>
    <li><strong>Project Manager:</strong> Hanna Mullikin</li>
    <li><strong>Email:</strong> <a href="mailto:hanna@brmwebdev.com">hanna@brmwebdev.com</a></li>
</ul>
<hr>
<ul>
    <li><strong>Website Files:</strong> <a href="#">View Repository</a></li>
    <li><strong>Report a Bug:</strong> <a href="#">Issue Tracker</a></li>
    <li><strong>Project Board:</strong> <a href="#"">Trello Board</a></li>
</ul>
<hr>
<p style="text-align:center;font-style:italic;">Do you need marketing, social, or SEO help? <a href="#">Ask us how we can help!</a></p>
EOT;
}

    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <div class="col-md-6 col-sm-12"><img src="http://www.ubtiinc.com/wp-content/uploads/2016/10/1icon.png" class="learnmore_icon" /> <a href="tel:714.912.1600"><span aria-hidden="true" class="glyphicon glyphicon-earphone"></span> 714.912.1600</a></div>
          <div class="col-md-5 col-sm-12"><img src="http://www.ubtiinc.com/wp-content/uploads/2016/10/2icon.png" class="learnmore_icon" /> <a href="mailto:info@ubtiinc.com"><span aria-hidden="true" class="glyphicon glyphicon-envelope"></span> info@ubtiinc.com</a></div>

          <div class="col-md-11 col-sm-12"><img src="http://www.ubtiinc.com/wp-content/uploads/2016/10/3icon.png" class="learnmore_icon" /><span style="color:#2d5fc4;">Or just send us a message below and we'll get right back to you.</span> </div>
        </div>
